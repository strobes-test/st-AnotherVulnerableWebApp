...
<div class="container-fluid text-center" style="margin-bottom: 120px !important;">
    <h1 class="h3 text-white link"><a href="<?= $routes->url("login"); ?>" class="badge badge-warning"><i class="fas fa-arrow-left"> Sign in here</i></a></h1>
</div>

<footer class="footer fixed-bottom">
    <div class="container-fluid px-3 py-3 bg-warning text-center">
